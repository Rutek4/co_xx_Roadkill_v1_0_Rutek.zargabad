// AI drivers, 1.0, Adds AI commanded by players as drivers to vehicles. By BlackHawk
// https://github.com/dklollol/Olsen-Framework-Arma-3/blob/master/modules/ai_drivers/init.sqf
...
_vehicles call FNC_enableAIDriver;
